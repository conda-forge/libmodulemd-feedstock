...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libmodulemd-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libmodulemd-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add libmodulemd
# for installing globally
pixi global install libmodulemd
```
...
It is possible to list all of the versions of `libmodulemd` available on your platform:
...
```
pixi search libmodulemd --channel conda-forge
```
